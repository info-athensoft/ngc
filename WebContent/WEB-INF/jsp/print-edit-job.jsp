...
<html>
	...
	<body>
				...
				<div class="container">
					<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="featured-box featured-box-secundary default">
										<div class="box-content">
											<h4>Step 1. Your file to print</h4>
											...
											<div class="row">
												...
												<form action="#">
													<table>
														<tr>
															<td width="380"><input type="text" value="No file uploaded." class="form-control" name="fileName" disabled="disabled"></td>
															<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button" value="Not this file?" class="btn btn-primary" name="" onclick="showUploadBox();"></td>
														</tr>
													</table>
												...
												<div id="edit_upload_file" style="display: none">
													<form action="#">
													<table>
														<tr><td><br/></td></tr>
														<tr>
														...
														<div class="col-md-12">
															<table>
																...
																<tr>
																	...
																	<td>
																		<input type="text" value="" class="form-control" name="edit_numOfPage">
																	</td>
																</tr>
																<tr><td><br/></td></tr>
																...
																<tr>
																	...
																	<td>
																		<input type="text" value="1" class="form-control" name="edit_numOfCopy">
																	</td>
																</tr>
																<tr><td><br/></td></tr>
															</table>
									...
									<div class="featured-box featured-box-secundary default">
										<div class="box-content">
											<h4>Step 4. Add a printing job</h4>
											...
											<div class="row">
												<div class="form-group">
													...
													<table>
														<tr>
															<td width="180">Printing Service Amount </td>
															<td>
													...
													<a href="#paper_size" class="btn btn-primary pull-right" onclick="updatePrintJob();">Update and Save</a>
						...
						<div class="col-md-12">
									...
									<div>										
										<a href="print_create.do" class="btn btn-primary">Create a new print job</a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="shop_cart.do" class="btn btn-primary pull-right">Add to cart</a>
									</div>
						</div>
						<!-- end of job list -->
		...
		<!-- Athensoft local js -->
		<script src="js/local/copycenter/print-edit-job.js"></script>

		...
		<div class="body">
			...
			<div role="main" class="main">
				...
				<div class="container">
					...
					<h2>Online <strong>Printing Services</strong></h2>
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							<a href="print_create_job.do" class="btn btn-lg btn-primary">Create Print Job Now</a>
							</div>
						</div>
					</div>
						...
						<div class="col-md-3 col-sm-6">
							<div class="featured-box featured-box-primary">
								<div class="box-content">
									...
									<p>your words go here<a href="/" class="learn-more">learn more <i class="fa fa-angle-right"></i></a></p>
								</div>
							</div>
						</div>
						<div class="col-md-3 col-sm-6">
